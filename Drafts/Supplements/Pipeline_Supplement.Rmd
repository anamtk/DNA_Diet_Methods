...
matrix_example <- read.csv(here("data", "denoised_data", "ASV_tables", "dada2_uc_asv_tab.tsv"), sep= "\t")
...
#Import ASV tables####
d2_uc <- read.csv(here("data", "denoised_data", "ASV_tables", "dada2_uc_asv_tab.tsv"), sep = "\t")
d2_c <- read.csv(here("data", "denoised_data", "ASV_tables", "dada2_c_prey_asv_tab.tsv"), sep = '\t')
d2_um <- read.csv(here("data", "denoised_data", "ASV_tables", "dada2_c_um_asv_tab.tsv"), sep = '\t')
d2_pred <- read.csv(here("data", "denoised_data", "ASV_tables", "dada2_c_pred_asv_tab.tsv"), sep = '\t')
u3_uc <- read.csv(here("data", "denoised_data", "ASV_tables", "unoise_uc_zotu_tab.txt"), sep = '\t')
u3_c <- read.csv(here("data", "denoised_data", "ASV_tables", "unoise_c_prey_zotu_tab.txt"), sep = '\t')
u3_um <- read.csv(here("data", "denoised_data", "ASV_tables", "unoise_c_um_zotu_tab.txt"), sep = '\t')
u3_pred <- read.csv(here("data", "denoised_data", "ASV_tables", "unoise_c_pred_zotu_tab.txt"), sep = '\t')
...
d2 <- read.csv(here("data", "denoised_data", "ASV_tables", 
...
d2_uc_ncbi <- read.csv(here("3_taxonomic_assignment", "MEGAN", "dada2_unclean",
                            "dada2_uc_ncbi_taxa.csv"))
#this is everything that got a taxonomic assignment through MEGAN
d2_uc_all <- read.csv(here("3_taxonomic_assignment", "MEGAN", "dada2_unclean",
                           "dada2_uc_all.csv"))
d2_uc_bold <- read.csv(here("3_taxonomic_assignment", "BOLD", "dada2_uc", 
...
#DADA2 CLEAN##
#import both NCBI and BOLD taxonomies
d2_c_ncbi <- read.csv(here("3_taxonomic_assignment", "MEGAN", "dada2_clean",
                           "prey", "dada2_c_prey_ncbi_taxa.csv"))
#this is everything that got a taxonomic assignment through MEGAN
d2_c_all <- read.csv(here("3_taxonomic_assignment", "MEGAN", "dada2_clean",
                           "prey", "dada2_c_prey_ALL.csv"))
d2_c_bold <- read.csv(here("3_taxonomic_assignment", "BOLD", "dada2_c", 
...
#UNOISE UNCLEAN##
#import both NCBI and BOLD taxonomies
u3_uc_ncbi <- read.csv(here("3_taxonomic_assignment", "MEGAN", "unoise_unclean",
                           "unoise_uc_ncbi_taxa.csv"))
u3_uc_bold <- read.csv(here("3_taxonomic_assignment", "BOLD", "usearch_uc", 
...
#UNOISE CLEAN##
#import both NCBI and BOLD taxonomies
u3_c_ncbi <- read.csv(here("3_taxonomic_assignment", "MEGAN", "unoise_clean",
                            "prey", "unoise_c_prey_ALL_ncbi_taxa.csv"))
u3_c_bold <- read.csv(here("3_taxonomic_assignment", "BOLD", "usearch_c", 
...
ord_tree <- read.tree(here("3_taxonomic_assignment", "bilateria_order.tre"))
...
fam_tree <- read.tree(here("3_taxonomic_assignment", "bilateria_family.tre"))
...
order_taxonomies <- read.csv(here("data", "taxonomic_data", "order_phylos.csv"))
...
#import taxonomies, set rownames, and make matrix
family_taxonomies <- read.csv(here("data", "taxonomic_data", "family_phylos.csv"))
