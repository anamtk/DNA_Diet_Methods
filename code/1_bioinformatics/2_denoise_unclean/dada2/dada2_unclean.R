...
#########################
#Get sample names and create empty vectors for filtered reads####
#########################
...
write.table(asv_tab, 
            here("data",
                 ...
                 "1_denoised_data",
                 "ASV_tables",
                 "dada2_uc_asv_tab.tsv"), sep="\t", quote=F, col.names=NA) 
